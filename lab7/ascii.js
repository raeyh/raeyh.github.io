...
function pageLoad() {
  ...
  for (var i = 0; i < radio.length; i++) {
    // using a loop to add event handlers to the 3 radio buttons
    var currentSpeed = radio[i].value;
    radio[i].onclick = (function (currentSpeed) {
      // update the speed, keep displaying frames during an animation
      return function () {
        speed = currentSpeed;
        if (interval) {
